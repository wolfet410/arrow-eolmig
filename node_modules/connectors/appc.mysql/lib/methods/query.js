...
exports.query = function (Model, options, callback) {
	...
	// DTC customization
	// Adding support for the customSqlQuery option, whereby a 
	// custom SQL query can be passed directly to the query method
	if (typeof options.where.customSqlQuery !== 'undefined') {
		var query =	options.where.customSqlQuery;
	} else {
