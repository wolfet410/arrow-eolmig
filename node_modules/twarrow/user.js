...
module.exports.getDetails = function(req, apikey) { 
    ...
    var Model = Arrow.getModel('appc.mysql.eolmig/User');
    var query = 'SELECT userId, email, firstName, lastName, enabled FROM User WHERE apikey = "' + apikey.apikey + '"';
    
    Model.query({ customSqlQuery: query }, function(err, userresults) {
        if (err) {
        ...
        // internalapi@gkn.com is valid in this configuration
