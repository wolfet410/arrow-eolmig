...
module.exports.getUserDetails = function(req) {
    ...
    req.server.getAPI('/api/user/current', 'GET').execute({ clientapikey: req.headers['x-api-key'] }, function(err, currentresults) {
        ...
        if (typeof currentresults === 'undefined' || typeof currentresults.result === 'undefined' 
            || typeof currentresults.result.roles === 'undefined' || currentresults.result.roles.length === 0) {
        ...
        twarrow.common.warn('api.js>getUserDetails: ERROR! ' + err);
    });
